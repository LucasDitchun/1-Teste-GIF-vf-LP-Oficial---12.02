    ...
    <section className="py-24 bg-black overflow-hidden">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col items-center text-center mb-16">
          ...
          <div className="inline-flex items-center gap-2 px-6 py-2.5 rounded-full border border-[#FF5A1F]/40 bg-[#FF5A1F]/10 text-[#FF5A1F] mb-8 animate-glow">
            ...
            <span className="text-sm font-black uppercase italic tracking-widest">Comunidade</span>
          </div>

          <h2 className="text-4xl md:text-7xl font-black text-white tracking-tighter leading-[1.1] mb-6 uppercase italic">
          ...
          <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed mb-12 font-medium">
            Faça parte de uma comunidade de corredores que compartilham a mesma paixão. Treinos em grupo, eventos exclusivos e muita motivação.
          </p>

          {/* LISTA DE BENEFÍCIOS */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-12 mb-16 text-left max-w-3xl mx-auto w-full">
        ...
        <div className="relative w-full max-w-6xl mx-auto">
          <div className="aspect-[16/9] md:aspect-[21/9] w-full rounded-[40px] md:rounded-[64px] overflow-hidden border border-white/5 shadow-2xl">
            <img 
              src={imageUrl} 
